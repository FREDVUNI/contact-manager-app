...
const AddContact = ({ category, setCategory }: Props) => {
  const inputStyles =
    "my-2 w-full px-5 py-3 border border-solid border-neutral-300 bg-transparent bg-clip-padding text-base font-normal text-neutral-700 outline-none placeholder:text-neutral-500";
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (response.ok) {
        ...
        const newContact = [...categoryContacts, data.data];
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 gap-2 lg:grid-cols-1">
            <input
              ...
              name="category"
              value={(contact.category = category)}
